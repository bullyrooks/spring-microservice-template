package com.{{ cookiecutter.service_namespace }}.{{ cookiecutter.package_name }}.config;
...
public class LoggingAspect {
    ...
    @Pointcut("within(@com.{{ cookiecutter.service_namespace }}.{{ cookiecutter.package_name }}.config.LoggingEnabled *)")
